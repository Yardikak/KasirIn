<x-layouts.layout>
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mt-4 mb-4">
            <h1 class="text-3xl font-bold text-gray-600">Create New Customer</h1>
            <div class="flex space-x-4">
                <a href="{{ route('customers.index') }}" class="block bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">
                    Back To List
                </a>
            </div>
        </div>
        ...
        <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 space-y-4">
                ...
                <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Create Customer</button>
            </div>
        </form>
    </div>
</x-layouts.layout>
