<x-app-layout>
                    ...
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            ...
                            <div class="card-body pb-0 px-0 px-md-4">
                                <img src="{{ asset('assets\theme\img\illustrations\man-with-laptop-light.png') }}" height="140" alt="View Badge User" data-app-dark-img="illustrations/man-with-laptop-dark.png" data-app-light-img="illustrations/man-with-laptop-light.png"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 order-1">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                            ...
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('assets\theme\img\icons\unicons\chart-success.png') }}" alt="chart success" class="rounded"/>
                                    </div>
                                    <div class="dropdown">
                      ...
                      <span class="fw-semibold d-block mb-1">Pendapatan Rp.</span>
                      <h3 class="flex card-title mb-2">12.000.000</h3>
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets\theme\img\icons\unicons\wallet-info.png') }}" alt="Credit Card" class="rounded"/>
                        </div>
                        <div class="dropdown">
                      ...
                      <span class="fw-semibold d-block mb-1">Penjualan Rp.</span>
                      <h3 class="card-title text-nowrap mb-1">4.600.000</h3>
                ...
                <div class="col-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                            <img src="{{ asset('assets\theme\img\icons\unicons\paypal.png') }}" alt="Credit Card" class="rounded" />
                        </div>
                        <div class="dropdown">
                          <button
                            class="btn p-0"
                ...
                <div class="col-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                          <img src="{{ asset('assets\theme\img\icons\unicons\cc-primary.png') }}" alt="Credit Card" class="rounded" />
                        ...
                        <div class="tab-content p-0">
                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                                <div class="d-flex p-4 pt-3">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ asset('assets\theme\img\icons\unicons\wallet.png') }}" alt="User" />
    ...
    <livewire:components.mini-notif />
